...
# from .embeddingapi_backup_1 import generate_embedding_qwen
...
#             # Vertex AI GenerativeModel.generate_content no longer supports
#             # the google-generativeai-style `request_options` kwarg. We rely on
#             # our own alarm-based timeout (Unix) and default client settings.
