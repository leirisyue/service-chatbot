...
def debug_products():
    ...
    cur.execute("SELECT COUNT(*) as total FROM products_sparse")
    total = cur.fetchone()['total']
    
    cur.execute("SELECT COUNT(*) as with_emb FROM products_sparse WHERE description_embedding IS NOT NULL")
    with_emb = cur.fetchone()['with_emb']
    
    cur.execute("SELECT category, COUNT(*) as count FROM products_sparse GROUP BY category ORDER BY count DESC")
...
def debug_materials():
    ...
    cur.execute("SELECT COUNT(*) as total FROM materials_sparse")
    total = cur.fetchone()['total']
    
    cur.execute("SELECT COUNT(*) as with_emb FROM materials_sparse WHERE description_embedding IS NOT NULL")
    with_emb = cur.fetchone()['with_emb']
    
    cur.execute("SELECT material_group, COUNT(*) as count FROM materials_sparse GROUP BY material_group ORDER BY count DESC")
